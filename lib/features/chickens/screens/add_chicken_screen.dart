...
class _AddChickenScreenState extends ConsumerState<AddChickenScreen> {
  ...
  final List<String> _statuses = ['laying', 'growing', 'broody', 'brooding', 'retired'];
  ...
  void initState() {
    ...
    _selectedHatchDate = DateTime.now().subtract(const Duration(days: 150)); // ~5 months old
  }
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _eggColors.map((color) {
                    return DropdownMenuItem(
                      value: color.toLowerCase() == 'other' ? null : color.toLowerCase(),
                      child: Text(color),
                    );
                  }).toList(),
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) => setState(() => _selectedStatus = value ?? 'laying'),
                ),
                const SizedBox(height: 16),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(_isLoading ? 'Adding...' : 'Add Chicken'),
                  ),
                ),
              ],
            ),
