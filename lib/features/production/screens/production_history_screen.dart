  ...
  Future<void> _selectDateRange() async {
    final picked = await showDateRangePicker(
      ...
      initialDateRange: DateTimeRange(
        start: _selectedStartDate ?? DateTime.now().subtract(const Duration(days: 90)),
        ...
        data: (allLogs) {
          ...
          final filteredLogs = allLogs
              .where((log) {
                ...
                return log.date.isAfter(_selectedStartDate!.subtract(const Duration(days: 1))) &&
          ...
          final avgEggsPerDay = filteredLogs.isEmpty ? 0.0 : totalEggs / filteredLogs.length;
          final avgEggsPerHen = totalHenDays == 0 ? 0.0 : totalEggs / totalHenDays;
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    ...
                    final dayOfWeek = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][log.date.weekday - 1];
