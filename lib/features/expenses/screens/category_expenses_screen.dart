...
class CategoryExpensesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CategoryExpensesScreen> createState() => _CategoryExpensesScreenState();
}

class _CategoryExpensesScreenState extends ConsumerState<CategoryExpensesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.category.toUpperCase()} Expenses'),
        elevation: 0,
        actions: [
          IconButton(
        ...
        child: expensesAsync.when(
          data: (expenses) {
            ...
            final categoryExpenses = expenses.where((expense) =>
                expense.category.toLowerCase() == widget.category.toLowerCase()).toList();

            final filteredExpenses = categoryExpenses.where((expense) {
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'No ${widget.category.toLowerCase()} expenses found',
            ...
            return ListView(
              ...
              children: [
                ...
                const AppSectionHeader(
                  title: 'Expenses',
                  subtitle: 'All records in this category',
                ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [_getCategoryColor(category), _getCategoryColor(category).withAlpha(178)],
